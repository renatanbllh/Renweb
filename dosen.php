...
<html lang="en">
  <head>
    ...
    <style>
      body{
            background-color:rgb(245, 100, 148);
...
<link rel=”icon” href=”logoupi.jpg”>
    <title>Dosen & Staff</title>
  </head>
  <body>

 <!-- NAVBAR -->
 <nav class="navbar navbar-light" style="background-color: #rgb(245, 100, 148);">
 <img src="laut.png" width="30" height="30" class="d-inline-block align-top" alt="">
    ...
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item " href="dosen.php">Dosen & Staff</a>
        </div>
      </li>
    </ul>
  </div>
...
<nav class="jumbotron text-center">
  <br>
  <img src="logoupi.jpg" alt="universitas pendidikan indonesia" width="200" class="rounded-circle"> 
  <h1 class="display-4">UNIVERSITAS PENDIDIKAN INDONESIA</h1>
  <p class="lead">UPI KAMPUS SERANG, SISTEM INFORMASI KELAUTAN</p>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#ffffff" fill-opacity="1" d="M0,128L48,122.7C96,117,192,107,288,117.3C384,128,480,160,576,181.3C672,203,768,213,864,202.7C960,192,1056,160,1152,154.7C1248,149,1344,171,1392,181.3L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
</nav>
<!-- AKHIR JUMBOTRON -->


<!-- GAMBAR  -->
<img src="header1.jpg" class="img-fluid" alt="...">
<!-- AKHIR GAMBAR  -->
...
<center>
      <div class="container marketing bg-light">
        ...
        <div class="row row-cols-1">
            <h2 class="blog-post-title">Dosen & Staff</h2>
            <p class="blog-post-meta"> Profile / Dosen & Staff </p>
            <br>
          <div class="col-lg-4 col-sm-3">
          <div class="pic"><img src="team/11.png" class="img-fluid" alt=""></div>
           
            <h5>NOVI SOFIA FITRIASARI</h5>
            <table>
            <td align="center">
                <tr>
                    <ul>
                        S.Si. - Universitas Padjadjaran (2007) <br>
          ...
          <div class="col-lg-4">
          <div class="pic"><img src="team/12.png" class="img-fluid" alt=""></div>
           
            <h5>AYANG ARMELITA ROSALIA</h5>
            <table>
                <td align="center">
                    <tr>
                        <ul>
                            S.Pi. - Institut Pertanian Bogor (2016) <br>
          ...
          <div class="col-lg-4">
          <div class="pic"><img src="team/13.png" class="img-fluid" alt=""></div>
           
            <h5>DELLA AYU LESTARI</h5>
            <table>
                <td align="center">
                    <tr>
                        <ul>
                            S.Si. - Universitas Indonesia (2017) <br>
          ...
          <div class="col-lg-4 col-sm-3">
          <div class="pic"><img src="team/14.png" class="img-fluid" alt=""></div>
            ...
            <table>
                <td align="center">
                    <tr>
                        <ul>
                            S.Pd. - Universitas Negeri Jakarta (2014) <br>
                            M.Si. - Institut Pertanian Bogor (2018) <br>
          ...
          <div class="col-lg-4">
          <div class="pic"><img src="team/15.png" class="img-fluid" alt=""></div>
            
            <h5>WILLDAN APRIZAL ARIFIN</h5>
            <table>
                <td align="center">
                    <tr>
                        <ul>
                            S.Pd. - Universitas Pendidikan Indonesia (2016) <br>
          ...
          <div class="col-lg-4">
          <div class="pic"><img src="team/16.png" class="img-fluid" alt=""></div>
            ...
            <table>
                <td align="center">
                    <tr>
                        <ul>
                            S.Pd. - Universitas Negeri Makasar (2015) <br>
                            M.Kom. - Institut Pertanian Bogor (2019) <br>
          ...
          <div class="col-lg-4">
          <div class="pic"><img src="team/17.png" class="img-fluid" alt=""></div>
           
            <h5>LA ODE ALAM MINSARIS</h5>
            <table>
                <td align="center">
                    <tr>
                        <ul>
                            S.Pi. - Universitas Halu Oleo (2015) <br>
